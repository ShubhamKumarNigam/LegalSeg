...
def main():
    ...
    parser.add_argument('--data_path', default = '../../data/Hier_BiLSTM_CRF/test/', type = str, help = 'Folder to store the unannotated text files')
    parser.add_argument('--model_path', default = '../../saved_models/Hier_BiLSTM_CRF/model_state4.tar', type = str, help = 'Path to trained Hierarchical BiLSTM CRF Model')
    ...
    parser.add_argument('--save_path', default = '../../output/Hier_BiLSTM_CRF/predictions.txt', type = str, help = 'Path to file where predictions will be saved')
    parser.add_argument('--word2idx_path', default = '../../saved_models/Hier_BiLSTM_CRF/word2idx.json', type = str, help = 'Path to word2idx dict created during training model')
    parser.add_argument('--tag2idx_path', default = '../../saved_models/Hier_BiLSTM_CRF/tag2idx.json', type = str, help = 'Path to tag2idx dict created during training model')
    ...
    parser.add_argument('--device', default = 'cuda', type = str, help = 'cuda / cpu') # cuda
